function [ SampleStats,txt ] = portPerformance( inputfile,securities,weights,startingCash,benchmark,rf )
% This function computes the performance of a user-specified portfolio

%% Inputs:
% inputfile: file where the price data is hosted
...
[num(:,:,i),txt,raw] = xlsread(inputfile,char(securities(i)));
